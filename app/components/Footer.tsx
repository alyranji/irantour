...
export default function Footer() {
  return (
    <footer className="bg-slate-200 w-full py-4 mt-8">
      <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 px-4 md:px-0">
